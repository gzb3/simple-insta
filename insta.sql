CREATE DATABASE  IF NOT EXISTS `instagram` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `instagram`;
...
CREATE TABLE `comments` (
  ...
  `authorUsername` varchar(127) NOT NULL,
...
CREATE TABLE `users` (
  ...
  `image` varchar(127) NOT NULL DEFAULT 'assets/avatar.jpg',
  `fullName` varchar(127) DEFAULT '',
...
-- Dump completed on 2019-04-09 21:26:45
